...
if ($cart_count > 0) {
    ...
    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
        ...
        // update quantity
        echo "<form class='update-quantity-form' id='inscription'>
                    <div class='product-id' style='display:none;'>{$id}</div>
                    <div class='input-group'>
                        <input type='number' name='quantity' value='{$quantity}' id='quantity' class='form-control cart-quantity'  />
 ...
 <?php
        ...
        echo "<a href='remove_from_cart.php?id={$id}' class='btn btn-default'>
            ...
            <div class='col-md-4'>
                <h4>$" . number_format($sub_total, 2, '.', ',') . "</h4>
            </div>
        </div>";
    ...
    <div class='col-md-4'>
        <div class='cart-row'>
            ...
            <a href='customer_orders.php' class='btn btn-success m-b-10px'>
