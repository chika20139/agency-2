...
if($_POST){
    ...
    try{
        ...
        // insert query
        $query = "INSERT INTO cart_items SET product_id=:product_id, quantity=:quantity, user_id=:user_id, created=:created";
    ...
    <table class='table table-hover table-responsive table-bordered'>
        ...
        <tr>
            ...
            <td>
                ...
                <a href='index1.php' class='btn btn-danger'>Back to read products</a>
            </td>
        </tr>
    </table>
</form>
